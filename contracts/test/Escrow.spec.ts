...
describe('Escrow', () => {
    ...
    it('It should work', async () => {
        ...
        // bridge tokens
        // bytes32 _targetBridge, address _token, address _receiver, uint256 _amount, uint256 _chainId, uint256 _salt)
        await escrow.bridge.sendTransactionAsync(padLeft(bridge.address, 64), token.address, user, bridgeAmount, chainBId, salt, {from: user});
